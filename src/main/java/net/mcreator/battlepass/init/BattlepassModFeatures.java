...
import net.mcreator.battlepass.world.features.BillsHouseFeature;
...
public class BattlepassModFeatures {
	private static final Map<Feature<?>, FeatureRegistration> REGISTRY = new HashMap<>();
	static {
		REGISTRY.put(BillsHouseFeature.FEATURE, new FeatureRegistration(GenerationStep.Decoration.SURFACE_STRUCTURES,
				BillsHouseFeature.GENERATE_BIOMES, BillsHouseFeature.CONFIGURED_FEATURE));
	}
