...
public class PoopBiomeFruitDecorator extends CocoaDecorator {
	public static final PoopBiomeFruitDecorator INSTANCE = new PoopBiomeFruitDecorator();
	public static com.mojang.serialization.Codec<PoopBiomeFruitDecorator> codec;
	public static TreeDecoratorType<?> tdt;
	static {
		codec = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		tdt = new TreeDecoratorType<>(codec);
		tdt.setRegistryName("poop_biome_tree_fruit_decorator");
		ForgeRegistries.TREE_DECORATOR_TYPES.register(tdt);
	}

	public PoopBiomeFruitDecorator() {
		super(0.2f);
	}
