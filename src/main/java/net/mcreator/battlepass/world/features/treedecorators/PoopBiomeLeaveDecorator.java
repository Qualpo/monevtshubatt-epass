...
public class PoopBiomeLeaveDecorator extends LeaveVineDecorator {
	public static final PoopBiomeLeaveDecorator INSTANCE = new PoopBiomeLeaveDecorator();
	public static com.mojang.serialization.Codec<LeaveVineDecorator> codec;
	public static TreeDecoratorType<?> tdt;
	static {
		codec = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		tdt = new TreeDecoratorType<>(codec);
		tdt.setRegistryName("poop_biome_tree_leave_decorator");
